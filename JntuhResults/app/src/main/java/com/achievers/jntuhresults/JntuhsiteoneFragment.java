...
public class JntuhsiteoneFragment extends Fragment {
    SwipeRefreshLayout swipeRefreshLayout;
    WebView webView;
    public JntuhsiteoneFragment()
    {
        //empty constructor
    }
