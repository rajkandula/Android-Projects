...
public class JntuhsitethreeFragment extends Fragment {
    SwipeRefreshLayout swipeRefreshLayout;
    WebView webView;
    public JntuhsitethreeFragment()
    {
        //empty constructor
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate (R.layout.fragment_sitethree,container,false);
        ...
        webView=(WebView)view.findViewById (R.id.webviewhome_three);
