...
public class DailyDevotions extends Fragment {

    WebView webView;
    public DailyDevotions()
    {
        //empty constructor
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate (R.layout.devotions_activity,container,false);
     ...
     //   webView.loadUrl ("https://docs.google.com/document/d/e/2PACX-1vR8-3lptW62-8tUdQmLxhAwLLlaqL7gFzyBiIijAKqV2suM9lcEwvTo5LfB72Qw4wEiyAt3KOEQ76-5/pub");
        webView.loadUrl("file:///android_asset/devotions.html"); //https://forms.gle/KjTrKfv7pgdgP5R88
       // webView.loadUrl("https://forms.gle/KjTrKfv7pgdgP5R88");
    /*    webView.setWebViewClient(new WebViewClient() {
            @Override
