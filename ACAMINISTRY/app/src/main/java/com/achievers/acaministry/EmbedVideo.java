...
public class EmbedVideo extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate (R.layout.embed_activity,container,false);
     ...
     //   webView.loadUrl ("https://docs.google.com/document/d/e/2PACX-1vR8-3lptW62-8tUdQmLxhAwLLlaqL7gFzyBiIijAKqV2suM9lcEwvTo5LfB72Qw4wEiyAt3KOEQ76-5/pub");
        webView.loadUrl("file:///android_asset/index.html"); //https://forms.gle/KjTrKfv7pgdgP5R88
